...
const Stories: React.FC = () => {
  ...
  return (
    <div ref={mainContainerRef} className="md:mt-[150px] overflow-hidden md:h-[950px] mt-20 mb-20 md:mb-[150px] stories-container  max-w-full w-full  ">
      <div className="flex flex-col md:flex-row space-x-10 md:ml-2 gap-8 md:gap-0">
        ...
        <div className="flex flex-col md:flex-row  md:space-x-4 overflow-hidden md:w-full">
  {/* First column */}
