        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center md:items-start items-center md:pt-20 pt-80 lg:pt-0">
            ...
            <p className="text-black text-base md:text-[16px] text-[10px] md:text-left text-center ">
              Lorem ipsum dolor sit amet consectetur. Enim mollis sagittis
              lectus vel vestibulum aliquet id ipsum eu. Facilisi pharetra proin
              id viverra nisl arcu bibendum aenean.
            </p>
          </div>
          ...
          <div className="lg:w-1/2 w-full relative  lg:-top-40 top-10 md:left-2 left-0 xl:left-35 bg-white md:rounded-[23px] rounded-[8px] p-6 md:p-8 shadow-lg">
            <form className="md:space-y-4 space-y-2">
              ...
              <div className="space-y-1">
                ...
                <select className="w-full md:h-[48px] h-[20px] px-3 bg-[#F1F1F6] text-[#B5B3B3] md:text-[14px] text-[8px] rounded-[4px]  ">
      ...
      `,
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-center md:mt-6 gap-1 text-center">
                      {resumeFile ? (
                        <span className="text-[#040444] text-sm md:text-base">
                          {resumeFile.name}
                        </span>
                      ) : (
                        <>
                          <span className="text-[#B5B3B3] text-xs md:text-sm">
                            Drag and drop your resume here
                          </span>
                          <span className="text-[#B5B3B3] text-xs md:text-sm">
                            or
                          </span>
                          <span className="text-[#040444] text-sm md:text-base font-medium">
                            click to upload
                          </span>
                        </>
                      )}
