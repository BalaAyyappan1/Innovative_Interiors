...
const ApplyHere: React.FC<ApplyHereProps> = ({
  ...
  const validateAllFields = (): boolean => {
    ...
    // Validate file
    const fileError = validateField('resume', formData.resume)
    if (fileError) {
            ...
            <div className="bg-white rounded-[23px] shadow-xl relative p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                      ...
                      {formData.resume ? (
                        ...
                        <>
                          ...
                          <p className="text-sm text-gray-600">
                            <span className="font-medium text-[#040444]">Click to upload</span> your resume*
                          </p>
                  ...
                  {errors.resume && (
                    <p className="text-red-500 text-xs mt-1 ml-1">{errors.resume}</p>
                  )}
                </div>
