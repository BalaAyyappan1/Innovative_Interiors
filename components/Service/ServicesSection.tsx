  ...
  return (
    <div className="w-full md:h-screen md:mt-36 mt-20   mx-auto">
      <div className="flex flex-col lg:flex-row">
        {/* Left Column */}
        <div className="w-full lg:w-[45%] px-4 lg:px-8 py-8">
          <div className="space-y-12">
            {/* Service 1 */}
            <div className="space-y-3">
              <h2 className="text-2xl md:text-3xl font-bold text-[#0A0A50]">
            ...
            {/* Service 2 */}
            <div className="space-y-3">
              <h2 className="text-2xl md:text-3xl font-bold text-[#0A0A50]">Civil Construction</h2>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div className="w-full lg:w-[45%] px-4 lg:px-8 py-8">
          <div className="space-y-12">
            {/* Service 5 */}
            <div className="space-y-3">
              <h2 className="text-2xl md:text-3xl font-bold text-[#0A0A50]">Design-Build Solutions</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Service 7 */}
            {/* <div className="space-y-3">
              <h2 className="text-2xl md:text-3xl font-bold text-[#0A0A50]">Procurement & Supply Chain Management</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Service 8 */}
            {/* <div className="space-y-3">
              <h2 className="text-2xl md:text-3xl font-bold text-[#0A0A50]">After-Sales Support & Service</h2>
              <p className="text-gray-700 leading-relaxed">
      ...
      <div className="lg:hidden w-full h-[200px] rounded-2xl bg-[#E5EAEB] my-8 flex items-end justify-center">
