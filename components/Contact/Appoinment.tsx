      ...
      <div className="w-full space-y-11 -mt-4">
        ...
        <div className="flex flex-col w-full">
          <textarea
            id="message"
            rows={10}
            className="flex-grow rounded-[8px] px-5 md:pt-4 pt-2 bg-[#F7F8FA]  md:text-[20px] text-[10px] text-[#969090] font-normal leading-6 focus:outline-none"
            placeholder="Message*"
            required
          />
        </div>
        ...
        <div className="md:w-[50%] w-full py-1 px-4 mt-6  space-y-6 bg-[#040444] rounded-[20px] hidden sm:block md:block ">
          <div className="mt-5 flex flex-col items-start justify-center space-y-1">
            <div className="text-white font-normal text-[30px]">Address</div>
