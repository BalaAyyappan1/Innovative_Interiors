...
const Appoinment = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-10 ">
      ...
      <div className="flex md:flex-row flex-col justify-between items-start w-full space-x-0 md:space-x-6 max-w-[1000px] mt-10 px-5">
        <div className="md:w-[60%] w-full flex flex-col items-start justify-center space-y-5">
          ...
          <div className="flex flex-col w-full">
            <textarea
              id="message"
              rows={5}
              className="flex-grow rounded-[8px] px-5 pt-4 bg-[#F7F8FA] md:h-[120px] h-[40px] md:text-[20px] text-[10px] text-[#969090] font-normal leading-6 focus:outline-none"
              placeholder="Message*"
              required
            />
          </div>
