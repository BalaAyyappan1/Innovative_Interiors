    ...
    <div className=" mx-auto w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 xl:gap-12 mt-10 md:mt-20 lg:mt-72">
        ...
        <div className="flex flex-col space-y-5 items-center xl:items-start">
          ...
          <h2 className="font-medium text-[20px] md:text-[40px]  2xl:text-[45px] leading-tight md:leading-tight 2xl:leading-[54px] font-medium text-center xl:text-left text-[#040444] max-w-3xl">
        ...
        <div className="flex flex-col justify-center">
          <p className="font-normal text-[14px] md:text-[20px]  text-center xl:text-left text-[#393535]">
