...
const Tower = () => {
  return (
    <div className="container mx-auto">
      <div className="flex flex-col justify-center items-center space-y-3 max-w-8xl mx-auto"> 
        <div className="flex md:flex-row flex-col items-center justify-between w-full border-b border-t border-[#000000] py-2 md:space-x-4">
          ...
          <div className="font-semibold flex md:flex-row flex-col md:items-center w-full md:space-x-18 text-[14px] text-[#040444]">
            <span className="md:w-[10%] md:text-center text-center text-[16px] md:text-[40px]">01</span>
            <span className="md:w-[30%] md:text-left text-center text-[16px] md:text-[40px]">CNC Precision <br className="hidden md:block" /> Cutting</span>
            <span className="md:w-[60%] text-[#393535] md:text-left text-center text-[16px] md:text-[25px]">
