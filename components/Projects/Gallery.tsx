...
const Gallery = () => {
  ...
  return (
    <div className="">
      <div className="flex md:flex-row flex-wrap justify-between md:gap-10 gap-5 w-full md:px-25 px-5 mb-[100px]">
        ...
        {imagesToShow.map((item, index) => (
          <div key={index} className="flex flex-col items-center">
            ...
            <div className="flex flex-row gap-2 items-end">
              <p className="mt-2 font-semibold text-[#040444] cursor-pointer text-[20px] text-center">
                {item.title}
              </p>
              <div className="w-7 h-7 text-black -rotate-45 flex flex-row items-center justify-center rounded-full">
