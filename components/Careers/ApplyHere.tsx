      ...
      <div className="max-w-7xl  mx-10  w-full">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center md:items-start items-center md:pt-20 pt-80 lg:pt-0">
            <h1 className="text-[#040444] md:text-[128px] text-[24px] font-semibold mb-4 md:leading-[135px] whitespace-nowrap">
              Apply here!
            </h1>
          ...
          <div className="lg:w-1/2 w-full relative  lg:-top-40 top-10 md:left-20 bg-white md:rounded-[23px] rounded-[8px] p-6 md:p-8 shadow-lg">
