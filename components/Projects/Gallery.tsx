...
import { CyteCare, Mih, Sakra, Annai, Bhagini, Confluence, Fitc, Aloft, Gokulam, itcvellore, Kakinada, radission, ramada, residency, rkpondy, tamara, zibe, cabin, conference, coWork, csscorp, edutech, extreme, featherlite, foodcourt, get, lycatel, micronics, newgen, sricity, tcs, tesa, elevenhouse, Adithya, Ashok, Jaffer, Kg, Krishna, murugus, nithya, pavillion, sundarHouse, usha, cakes, grt, kama, ombc, rns, spa, kate, Aloft1, Aloft3, Aloft2, Annai3, Annai2, Annai1, Bhagini2, Bhagini3, Bhagini1, Confluence1, Confluence2,  kakinada3, kakinada2, kakinada1, fitc1, itcvellore3, itcvellore1, itcvellore2, radi1, radi2, radi3, ramada1, ramada2, ramada3, residency1, residency2, residency3, rk1, rk2, rk3, tamara1, tamara2, tamara3, zibe3, zibe2, zibe1, cc3, cc2, cc1, sakra3, sakra1, sakra2, cakes1, cakes2, grt3, grt2, grt1, kate3, kate2, kate1, rns2, rns3, rns1, spa3, spa2, spa1, sony1, kama3, kama2, kama1, ombc3, ombc2, ombc1, house1, house2, house3, ashok2, ashok1, ashok3, murugus3, murugus2, murugus1, kg2, kg1, krishna3, krishna2, krishna1, sundarhouse3, sundarhouse2, sundarhouse1, adithya1, adithya2, adithya3, jaffer3, jaffer2, jaffer1, nithya3, nithya1, nithya2, pavi1, pavi3, pavi2, usha3, usha2, usha1, cabin1, cabin3, cowork1, cowork2, conf1, conf2, conf3, csscorp1, csscorp2, csscorp3, edutech1, edutech2, edutech3, extreme1, extreme2, feather1, feather2, feather3, food1, food2, food3, get1, get2, get3, lyca1, lyca2, lyca3, micro1, micro2, micro3, newgen1, newgen2, newgen3, sricity1, sricity2, sricity3, tsc1, tsc2, tsc3, tesa1, tesa2, tesa3, Aloft6, Aloft10, Aloft4, Aloft5, Aloft7, Aloft8, Aloft9, Aloft11, Aloft12, Aloft13, Aloft27, Aloft14,
  Aloft15,
  Aloft16,
  Aloft17, Aloft18, Aloft19, Aloft20, Aloft21, Aloft22, Aloft23, Aloft24, Aloft25, Aloft26,
  Bhagini5,
   Bhagini6, Bhagini7, Bhagini8, Bhagini9, Bhagini10, Bhagini11, Bhagini12, Gokulam1,
   Gokulam2,
   Gokulam3,
   Gokulam4,
   Gokulam5,
  ...
  const imagesMap = {
    Residental: [
      {
        image: elevenhouse,
        title: "11 House",
        sliderImages: [house1, house2, house3, house4,house5, house6, house7, house7, house8, house9, house10, house11, house12],
      },
      {
        image: Ashok,
        title: "Ashok Sattanathan Residence",
        sliderImages: [ashok1, ashok2, ashok3, ashok4, ashok5, ashok6, ashok7, ashok8, ashok9, ashok10],
      },
      {
        image: murugus,
      ...
      },
      {
        ...
        sliderImages: [sundarhouse1, sundarhouse2, sundarhouse3, sundarhouse4, sundarhouse5, sundarhouse6, sundarhouse7, sundarhouse8, sundarhouse9, sundarhouse10],
      },
      {
        image: Adithya,
      ...
      },
      {
        ...
        sliderImages: [jaffer1, jaffer2, jaffer3, jaffer4, jaffer5, jaffer6, jaffer7, jaffer8, jaffer9, jaffer10],
      },
      {
        image: nithya,
      ...
      },
      {
        ...
        sliderImages: [pavi1, pavi2, pavi3, pavi4,  pavi5, pavi6, pavi7, pavi8, pavi9, pavi10 ],
      },
      {
        image: usha,
        title: "Usha Srinivasan",
        sliderImages: [usha1, usha2, usha3, usha4, usha5, usha6, usha7, usha8, usha9, usha10],
      },
    ],
    Hotels: [
      {
      ...
      },
      {
        image: Bhagini,
        title: "Bhagini",
        sliderImages: [Bhagini1, Bhagini2, Bhagini3,  Bhagini5, Bhagini6, Bhagini7, Bhagini8, Bhagini9, Bhagini10, Bhagini11, Bhagini12],
      },
      {
        image: Confluence,
        title: "Confluence",
      ...
      },
      {
        ...
        sliderImages: [kakinada1, kakinada2, kakinada3, kakinada4, kakinada5, kakinada6, kakinada7, kakinada8, kakinada9, kakinada10, kakinada11, kakinada12, kakinada13, kakinada14, kakinada15, kakinada16, kakinada17, kakinada18, kakinada19, kakinada20, kakinada21, kakinada22, kakinada23, kakinada24, kakinada25, kakinada26, kakinada27],
      },
      {
        image: Fitc,
        title: "ITC Tirupur",
      ...
      },
      {
        image: itcvellore,
        title: "ITC Vellore",
        sliderImages: [itcvellore1, itcvellore2, itcvellore3, itcvellore4, itcvellore5, itcvellore6, itcvellore7, itcvellore8, itcvellore9, itcvellore10, itcvellore11, itcvellore12, itcvellore13, itcvellore14, itcvellore15, itcvellore16, itcvellore17, itcvellore18, itcvellore19, itcvellore20, itcvellore21, itcvellore22, itcvellore23, itcvellore24,],
      },
      {
        image: radission,
        title: "Radisson Blu",
        sliderImages: [radi1, radi2, radi3, radi4, radi5, radi6, radi7, radi8, radi9, radi10, radi11, radi12, radi13, radi14],
      },
      {
        image: ramada,
        title: "Ramada",
      ...
      },
      {
        ...
        sliderImages: [residency1, residency2, residency3, residency4, residency5, residency6, residency7, residency8, residency9, residency10, residency11],
      },
      {
        image: rkpondy,
        title: "RKR Pondy",
        sliderImages: [rk1, rk2, rk3, rk4, rk5, rk6, rk7, rk8, rk9, rk10, rk11, rk12, rk13, rk14, rk15, rk16, rk17, rk18, rk19, rk20, rk21, rk22, rk23, rk24, rk25, rk26, rk27, rk28, rk29, rk30, rk31, rk32, rk33, rk34, rk35, rk36, rk37, rk38, rk39],
      },
      {
        image: tamara,
        title: "Tamara cbe",
        sliderImages: [tamara1, tamara2, tamara3, tamara4, tamara5, tamara6, tamara7, tamara8, tamara9, tamara10],
      },
      {
        image: zibe,
        title: "ZIBE",
    ...
    Retail: [
      ...
      },
      {
        ...
        sliderImages: [grt1, grt2, grt3, grt4, grt5, grt6, grt7, grt8, grt9, grt10],
      },
      {
        image: kate,
        title: "kate & Oscar",
      ...
      },
      {
        image: ombc,
        title: "OMBC",
        sliderImages: [ombc1, ombc2, ombc3, ombc4, ombc5, ombc6, ombc7, ombc8, ombc9],
      },
    ],
    Healthcare: [
      {
        image: CyteCare,
        title: "Cyte Care",
        sliderImages: [cc1, cc2, cc3, cc4, cc5, cc6, cc7, cc8, cc9, cc10, cc11, cc12, cc13, cc14, cc15, cc16, cc17, cc18, cc19, cc20, cc21, cc22, cc23, cc24, cc25, cc26, cc27, cc28],
      },
      {
        image: Mih,
        title: "MIH",
        sliderImages: [mih1, mih2, mih3, mih4, mih5, mih6, mih7, mih8, mih9, mih10,
          mih11, mih12, mih13, mih14, mih15, mih16, mih17, mih18, mih19, mih20,
          mih21, mih22, mih23, mih24, mih25, mih26, mih27, mih28, mih29, mih30,
          mih31, mih32, mih33, mih34, mih35, mih36, mih37, mih38, mih39, mih40
          ],
      },
      {
        image: Sakra,
    ...
    Workspaces: [
      ...
      },
      {
        image: featherlite,
        title: "Featherlite",
        sliderImages: [feather1, feather2, feather3, feather4, feather5, feather6, feather7, feather8, feather8, feather9, feather10],
      },
      {
        image: get,
        title: "GET",
      ...
      },
      {
        image: micronics,
        title: "Micronics",
        sliderImages: [micro1, micro2, micro3, micro4, micro5, micro6, micro7, micro8, micro9, micro10],
      },
      {
        image: newgen,
        title: "Newgen",
      ...
      <div className="hidden md:flex md:flex-row flex-wrap justify-between md:gap-10 gap-5 w-full md:px-25 px-5 mb-[100px]">
        {title.map((item, index) => (
          <div key={index} className="flex flex-row flex-grow md:gap-2">
            <h2
              className={`md:text-[24px] text-[14px] font-normal cursor-pointer ${activeTitle === item.title
      ...
      >
        {title.map((item, index) => (
          <div key={index} className="inline-block">
            <h2
              className={`text-[14px] font-normal cursor-pointer whitespace-nowrap ${activeTitle === item.title
