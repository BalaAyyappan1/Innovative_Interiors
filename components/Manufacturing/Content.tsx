...
const Content = () => {
  return (
    <div className="md:mb-80 mb-30">
      <div className="flex xl:flex-row flex-col space-x-190 px-5  xl:justify-between justify-center space-y-5">
      ...
      <div className="flex flex-col items-center w-full md:items-start md:w-auto space-y-5">
        <div>
          <p className="font-semibold text-[16px] xl:text-[55.91px] xl:leading-[69px] md:text-start text-center text-[#040444]">
